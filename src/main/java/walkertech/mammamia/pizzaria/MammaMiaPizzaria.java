...
public class MammaMiaPizzaria {
    ...
    private static final Logger logger = LogManager.getLogger(MammaMiaPizzaria.class);
    ...
    public static void main(String[] args) {
        ...
        logger.info("Deseja cadastrar um novo cliente? (S/N)");
        ...
        logger.info("Lista de clientes cadastrados:");
        for (Cliente c : clientes) {
            logger.info("Nome: " + c.getNome() + " | Endereço: " + c.getEndereco() + " | Telefone: " + c.getTelefone());
        }
